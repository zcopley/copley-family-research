...
| Grantee index A-F, 1817-1934 | Film 819924 / DGS 8135143 | Not sufficient for Eureka Pipe Line: firms / corporations reach only Ba-Br before the film cuts to a new grantor-index volume; find the continuation film for C-F companies |
...
Capture each full index line, headings, image number, instrument type, date, parties, book/page, and marginal notation. Retrieve the underlying deed / lease image whenever possible. Preserve record `6X4N-DWWY` as a located family exchange deed, not the South Penn lease, and use the original image rather than its malformed FamilySearch relationship index. Do not repeat the older 1878 / page 321 reading unless a new image pass proves it, and do not repeat the Copley grantor-index search unless verifying the documented Colvin-to-Cork negative. Do not repeat the Standard Oil grantee path unless verifying the documented Stalnaker-to-Swisher negative; Eureka Pipe Line requires a continuation film beyond the Ba-Br company pages on Film 819924.
