...
| Grantee index A-F, 1817-1934 | Film 819924 / DGS 8135143 | Eureka unresolved: high-resolution checks of images 391-392 found no Eureka Pipe Line / Copley / Book 42 entry; if continuing, inspect possible company / firm pages around images 388-395 and nearby continuation pages at native-tile resolution |
...
Capture each full index line, headings, image number, instrument type, date, parties, book/page, and marginal notation. Retrieve the underlying deed / lease image whenever possible. Preserve record `6X4N-DWWY` as a located family exchange deed, not the South Penn lease, and use the original image rather than its malformed FamilySearch relationship index. Do not repeat the older 1878 / page 321 reading unless a new image pass proves it, and do not repeat the Copley grantor-index search unless verifying the documented Colvin-to-Cork negative. Do not repeat the Standard Oil grantee path unless verifying the documented Stalnaker-to-Swisher negative. Do not reuse low-resolution Eureka reads from Film 819924 images 391-392 unless native-tile inspection confirms them; the high-resolution pass did not.
