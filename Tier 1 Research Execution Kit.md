...
- A follow-up checked `i3811884-00376`. It is another proof / summary page, not a named taxable-persons page. It shows `for the year 185`, with the final digit cut off, and no legible district or commissioner.
- A follow-up checked `i3811884-00375`. It is a taxable-persons page, page 14, directly before proof page `00376`; its district field is blank / unreadable and it has no year or commissioner.
- A follow-up checked `i3811884-00374`. It is another proof / summary page with `for the year 185`, final digit cut off, no legible district / commissioner, and a `No. 30` proof-box clue confirming page-sequence continuity.
- A follow-up checked `i3811884-00373`. It is a taxable-persons page, page 13, immediately before proof page `00374`; its district field is blank / not filled in, it has no year or commissioner, and it confirms the J-section to M-section page sequence.
- A follow-up checked `i3811884-00372`. It is another proof / summary page with `for the year 185`, final digit cut off, and a blank district / commissioner field. It extends the sequence backward to proof `00372` -> page 13 / `00373`.
- A follow-up checked `i3811884-00371`. It is taxable-persons page 12, with H-section names and `Jackson, George` at the page bottom. The right side of the header is cut off, so no year, district, or commissioner was readable.
- A follow-up checked `i3811884-00370`. It is a two-page proof / taxable spread with the same `for the year 185` truncation or absence, blank district field, and no commissioner name.
- A follow-up checked `i3811884-00369`. It is taxable-persons page 11, with H-section names, a blank district field, and no visible year or commissioner.
- A follow-up checked `i3811884-00368`. It is a two-page proof / summary spread immediately before taxable-persons page `00369`; the district name is obscured in the gutter, the year again reads only `185`, and no commissioner name appears.
...
3. Capture any visible:
   - full year
   - district number or district name
   - commissioner name
   - page number
...
- District / commissioner, if visible:
- Page number / sequence clues:
...
Subject: Certified Copy Request - Deed Book 42, Page 267 (Anna Copley to South Penn Oil Company, Oil and Gas Lease, ca. 1899)
...
A related family exchange deed is already located at FamilySearch record `6X4N-DWWY`, DGS `008293301`, image `245`, pages 422-423. It was executed 22 August 1900 and recorded 13 October 1900. It is not the oil lease; please use it as a title-chain anchor and do not return it as the requested South Penn instrument. Its cited older deed is now visually verified at Deed Book 11 page 321, DGS `008293286` images `193-194`: a 1 May 1880 conveyance, recorded 24 February 1881, of 200 acres on Land Fork / Sand Fork / Cove Lick to Michael and John Copley.

The online Book 39 page 138 lease, Film / DGS 008293301 image 444, is a companion Land Fork lease naming Anna, Bridget, Margaret, and Sarah E. Copley as South Penn lessors. It is useful context but should not be substituted for the requested Book 42 Sand Fork lease.

Please advise the copy fee and preferred payment method.
...
| Grantee index N-Z, 1817-1934 | Film 819926 / DGS 7902191 | Anna Copley lease match found at image 310; reported South Penn pages checked had no other Copley entries; Standard Oil path closed as bounded negative in images 310-360 |
| Deed Book 11 | DGS 008293286 | Source deed visually verified at page 321 / images 193-194; recorded 24 February 1881; the `Old to John Copley March 21 . 1886` deed-index path is now a bounded negative in the checked grantor, grantee, DB 16, and DB 17 paths |

Capture each full index line, headings, image number, instrument type, date, parties, book/page, and marginal notation. Retrieve the underlying deed / lease image whenever possible. Preserve record `6X4N-DWWY` as a located family exchange deed, not the South Penn lease, and use the original image rather than its malformed FamilySearch relationship index. Treat the old 1878-date / page-32? ambiguity as resolved: the source deed is 1 May 1880, Book 11 page 321, recorded 24 February 1881. Do not repeat the broad Copley grantor-index search unless verifying the documented Colvin-to-Cork negative. Do not repeat the 21 March 1886 Michael-to-John deed-index search unless verifying the bounded negative; further work on that note should use original clerk materials, broader DB 16 variant-docket browsing, or non-deed records. Do not repeat the Standard Oil grantee path unless verifying the documented Stalnaker-to-Swisher negative. Do not repeat the Eureka Pipe Line grantee path unless a new independent citation points to a different index series or book/page; Film 819924 image 437 closes the relevant E-company section as a bounded negative.
