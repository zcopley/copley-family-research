...
**CENSUS FOLLOW-UP:** Added the 1900 census neighborhood check for **Frank N Partlow** and **Mary A Rude** in Johnson Township, Clark County, Illinois. Both were recorded single at the 1 Jun 1900 census reference date, Frank on sheet 7A and Mary A. Rude on sheet 7B, which is consistent with but does not prove the reported 10 Jun 1900 marriage.
...
- [[References/Clark County Illinois Partlow Rude Marriage Request|Clark County Illinois Partlow Rude Marriage Request]], [[References/Clark County Illinois 1900 Partlow Rude Census Check|Clark County Illinois 1900 Partlow Rude Census Check]], [[References/New England Ball Project Partlow Census Citation Extract|New England Ball Project Partlow Census Citation Extract]], [[RQ-P1-PARTLOW-REVOLUTIONARY-LINE|RQ-P1 Partlow Revolutionary Line]], [[Open Record Targets]], [[Volunteer Record Request Tasks]], [[Research Priorities and Action Items]], [[Sources and Evidence Index]], and [[Search Index]] - recorded the FamilySearch collection 1803970 negative, the Clark County marriage-film cutoff after 1899, the found 1900 census context, and the current clerk / newspaper / later-obituary path.
...
- Raw source reports preserved at `static/sources/claude-michael-parents/michael-copley-sr-order-book-1a-repository-access-path-claude-output.txt`, `static/sources/claude-michael-parents/michael-copley-sr-settlement34-probate-p-access-path-claude-output.txt`, `static/sources/claude-michael-parents/lewis-county-clerk-michael-copley-probate-request-channel-claude-output.txt`, `static/sources/claude-partlow/clark-county-partlow-rude-marriage-familysearch-negative-claude-output.txt`, and `static/sources/claude-partlow/partlow-rude-1900-census-johnson-township-claude-output.txt`.
