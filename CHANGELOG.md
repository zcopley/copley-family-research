...
- [[References/Clark County Illinois Partlow Rude Marriage Request|Clark County Illinois Partlow Rude Marriage Request]], [[References/Clark County Illinois 1900 Partlow Rude Census Check|Clark County Illinois 1900 Partlow Rude Census Check]], [[References/Clark County Herald 1900 Partlow Rude Marriage License Notice|Clark County Herald 1900 Partlow Rude Marriage License Notice]], [[References/New England Ball Project Partlow Census Citation Extract|New England Ball Project Partlow Census Citation Extract]], [[RQ-P1-PARTLOW-REVOLUTIONARY-LINE|RQ-P1 Partlow Revolutionary Line]], [[Open Record Targets]], [[Volunteer Record Request Tasks]], [[Research Priorities and Action Items]], [[Sources and Evidence Index]], and [[Search Index]] - recorded the FamilySearch collection 1803970 negative, the Clark County marriage-film cutoff after 1899, the found 1900 census context, the found 8 Jun 1900 newspaper license notice, and the current clerk / later-obituary path.
- `CLAUDE.md`, `GEMINI.md`, and `.agents/AGENT_RESUME.md` - refreshed agent guidance so future work does not repeat the exhausted FamilySearch / generic index searches.
- Raw source reports preserved at `static/sources/claude-michael-parents/michael-copley-sr-order-book-1a-repository-access-path-claude-output.txt`, `static/sources/claude-michael-parents/michael-copley-sr-settlement34-probate-p-access-path-claude-output.txt`, `static/sources/claude-michael-parents/lewis-county-clerk-michael-copley-probate-request-channel-claude-output.txt`, `static/sources/claude-partlow/clark-county-partlow-rude-marriage-familysearch-negative-claude-output.txt`, `static/sources/claude-partlow/partlow-rude-1900-census-johnson-township-claude-output.txt`, and `static/sources/claude-partlow/partlow-rude-1900-clark-county-herald-marriage-license-claude-output.txt`.
