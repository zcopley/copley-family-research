---
title: Harry C Partlow 1960 Letter and Handwritten Lineage
aliases:
  - Partlow 1960 Letter
  - Partlow Handwritten Lineage
date: 2026-04-28
tags:
  - "#copley-family"
  - "#partlow-line"
...
```mermaid
graph TD
    J1["I. John Partlow I<br/>1710-c.1750<br/>Wales -> Spotsylvania Co., VA"]
    J2["II. John Partlow II<br/>1736-11 Nov 1789<br/>Virginia"]
    B["III. Benjamin Partlow<br/>1762-1837<br/>Culpeper Co., VA"]
    JAC["IV. Jacob Partlow<br/>1790-1868<br/>Culpeper Co., VA -> Clark Co., IL"]
    JH["V. John H. Partlow<br/>1811-1870<br/>Virginia -> Illinois -> Arkansas"]
    MAR["VI. Marion M. Partlow<br/>1844-1922<br/>Clark Co., IL"]
    FR["VII. Frank Partlow<br/>1874-21 Nov 1956"]
    AR["Alice Rude Partlow<br/>1880-20 Jan 1962"]
    CHILDREN["VIII. Children<br/>Laura, Harry C., Marion E., Raymond,<br/>Lester O., Genevieve, Doris"]
    PHILIP["IX. Philip Partlow<br/>son of Raymond"]
    GEN10["X. Possible tenth generation<br/>noted as expected in 1977"]

    J1 --> J2 --> B --> JAC --> JH --> MAR --> FR
    AR --> CHILDREN
    FR --> CHILDREN
    CHILDREN --> PHILIP --> GEN10

    class J1,J2,B,JAC,JH,MAR,FR direct
    class AR,CHILDREN,PHILIP,GEN10 manuscript

    classDef direct fill:#e7f5ff,stroke:#1971c2,color:#102a43;
    classDef manuscript fill:#fff3bf,stroke:#8a6d00,color:#1f1f1f;
```
...
```mermaid
flowchart LR
    M["1977 handwritten lineage"]
    L["Strong family-source lead"]
    O["Needs original records"]
    R1["Civil/vital records"]
    R2["Census households"]
    R3["Probate and land records"]
    R4["DAR and pension files"]
    V["Verified proof chain"]
    ...
    class M,L family
    class O warning
    class R1,R2,R3,R4 records
    class V verified

    classDef family fill:#fff3bf,stroke:#8a6d00,color:#1f1f1f;
    classDef warning fill:#ffe3e3,stroke:#c92a2a,color:#1f1f1f;
    classDef records fill:#e7f5ff,stroke:#1971c2,color:#102a43;
    classDef verified fill:#d3f9d8,stroke:#2b8a3e,color:#102a12;
```
