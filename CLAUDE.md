...
- The Partlow / Rude marriage path has changed: FamilySearch collection 1803970, the Illinois statewide index, Ancestry, and other online county-record paths are checked negative / gap-limited for the reported 10 Jun 1900 Clark County marriage, and the last Clark County marriage film, Film 1306062 / DGS 4539347, ends with 1899 records. The 1900 census places Frank N Partlow and Mary A Rude single in Johnson Township, ED 8, on the 1 Jun reference date. A *Clark County Herald* notice dated 14 Jun 1900 reports a license issued under 8 Jun to `Frank Partlow, 25, Moonshine` and `Alice Rude, 19`; this proves license issuance and strongly supports the reported marriage but does not supply the ceremony return. Do not reassign generic FamilySearch, generic 1900 census, broad Ancestry, or broad Marshall-newspaper searches unless a new source appears; next use Clark County Clerk / Recorder and Marshall Public Library genealogy collection for the original / reconstructed license, return, register, or local extract. The key local extract target is `Extract of marriages from Clark County, 1819-1900`, v. 3, confirmed at FamilySearch Library call no. `977.371 V25c` / Film 1036682 / DGS 7955859 but not online. Later death / obituary / cemetery evidence is still needed to tie Frank N / Nollie Franklin to Alice / Mary Alice.
