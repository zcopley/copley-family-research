...
- The Partlow / Rude identity path has changed: Frank Partlow = Nollie Franklin Partlow, Alice Rude = Mary Alice Rude Partlow, and Marion Elizabeth Partlow's parentage are now proved for project purposes by the web-only chain in `References/Partlow Rude Online Identity Chain.md`. The original 1880 census image is found at `References/1880 Marion McDonald Partlow Household.md`, confirming Nollie Frank as son of Marion Partlow. The original 1850 / 1860 census images are found at `References/1850 and 1860 John Halleck Partlow Household.md`, confirming Marion / Marion M. as child of John H. / Lydia Partlow. `References/Partlow Upstream Revolutionary Line Web Search.md` preserves the completed broad upstream web pass, but `References/Rappahannock Partlow Chancery Case 1842-002.md` is now the controlling corrective source: images 1-4 name Benjamin Partlow's children / heirs and omit Jacob / Jacob Newton / Nute Partlow. Do not state Benjamin as Marion's proven ancestor. The remaining Partlow web task is to read Rappahannock chancery images 5-69, check Rappahannock Will Book A p. 223, Culpeper Deed Book FF pp. 394-395 / nearby Partlow deeds, and search for Jacob Newton Partlow's correct parents or an explanation for his omission. Do not reassign generic FamilySearch, generic 1850 / 1860 / 1880 / 1900 census, broad Ancestry, broad Marshall-newspaper, Clerk / Marshall Library, or broad Jacob / Benjamin web-search tasks unless a new repository or citation is involved.
