...
- The Partlow / Rude identity path has changed: Frank Partlow = Nollie Franklin Partlow, Alice Rude = Mary Alice Rude Partlow, and Marion Elizabeth Partlow's parentage are now proved for project purposes by the web-only chain in `References/Partlow Rude Online Identity Chain.md`. The original 1880 census image is found at `References/1880 Marion McDonald Partlow Household.md`, confirming Nollie Frank as son of Marion Partlow. The original 1850 / 1860 census images are found at `References/1850 and 1860 John Halleck Partlow Household.md`, confirming Marion / Marion M. as child of John H. / Lydia Partlow. `References/1883 Perrin Marion Partlow Biography.md` corrects the old "1888 history" lead: Perrin 1883 supports John H. -> Jacob only and does not mention Benjamin. `References/Jacob Partlow Clark County Probate Will Lead.md` now records the original Clark County will-book entry and probate-index entries for Jacob's 1867 will / 1868 probate. The probate index has `PARTLOW Jacob - 188` and `PARTLOW Jacob - (CC) 166`; the latter is identified as Probate Journal / Probate Order Book vol. CC p. 166 and is not online in the checked Ancestry / FamilySearch reel set. The estate-paper index points Jacob to box 46, also offline. DGS `7655347` did not resolve `PARTLOW John M. - 1/28`; DGS `7655349` Guardian Book B pages 1-41 are checked negative for Partlow / Ridenhouse variants. `References/Rappahannock Partlow Chancery Case 1842-002.md` is the controlling corrective source for the Benjamin question: the complete 69-image file names Benjamin Partlow's eight child / heir lines, distributes the estate in eight shares, and omits Jacob / Jacob Newton / Nute Partlow throughout. Do not state Benjamin as Marion's proven ancestor. The next web-accessible Partlow task is to continue DGS `7655349` Guardian Book B from image `00408` through about 1871, if the user wants more web-only probate work. Do not reassign generic FamilySearch, generic 1850 / 1860 / 1880 / 1900 census, broad Ancestry, broad Marshall-newspaper, Clerk / Marshall Library for Partlow/Rude, Rappahannock images 5-69, broad Jacob / Benjamin web-search tasks, the old 1888 history capture task, the original Jacob will-book task, the already-checked probate-index / will-record images, `CC 166` as an online target, 1868-1872 Marshall searchable-newspaper searches, DGS `7655347` P-section, or Guardian Book B pages 1-41 unless a new repository or citation is involved.
