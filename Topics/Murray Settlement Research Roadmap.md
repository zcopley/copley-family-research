...
|--------|-------|------|-----------------|
| Non-indexed Lewis County Murray record path check | FamilySearch Catalog / WV archives pathfinding: tax lists, will / estate files, probate books, grantor indexes, deed books, and locked browse-only county records; capture in [[RQ-M1-LEWIS-COUNTY-FAN-SWEEP|RQ-M1 Lewis County FAN Sweep]] | 1-2 hrs | **HIGH:** moves beyond the negative indexed search for older Luke / Margaret into the records most likely to preserve pre-1860 evidence |
...
- [ ] Non-indexed Lewis County tax / estate / probate / grantor path check in [[RQ-M1-LEWIS-COUNTY-FAN-SWEEP|RQ-M1 Lewis County FAN Sweep]] (RQ-M1)
