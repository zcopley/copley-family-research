...
|--------|-------|------|-----------------|
| James Murray tax-row verification and 1855-1860 gap closure | Ancestry Lewis County personal-property-tax images: verify the `Murray James` row on `i3811884-00377`, inspect proof page `i3811884-00378` for district / commissioner / year clues, then capture / transcribe the 1853 Eliza Jane Murry and 1854 Loghan rows; finish 1855 partial, 1856, and 1857-1860 | 1-2 hrs | **HIGH:** confirms whether James and Patrick belong to the same tax-list sequence and tests whether Luke appears after the current 1855 cutoff |
