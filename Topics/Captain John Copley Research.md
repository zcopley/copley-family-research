...
✅ **[RESOLVED FOR WORKING GENEALOGY — April 2026]** Tom raised the question of whether **Anne "Munday"** (Michael Copley's wife, b. ~1823) might actually be **Anne Murray**. The evidence now strongly supports that conclusion:
...
The working conclusion is that Ann "Munday" was almost certainly Ann Murray, with "Munday" entering American records through phonetic transcription, clerical error, or oral-family transmission. The direct-record task remains open: identify which Kinawley Murray household was Ann's family and find a surviving marriage, passenger, church, or deed record if possible. See [[RQ-M5-PHASE-2-FINDINGS|RQ-M5 Phase 2 Findings]].
...
| # | Question | Why It Matters | Where to Look |
|---|----------|---------------|---------------|
| RQ-16 | Which Kinawley Murray household was Ann "Munday" Copley's family? | RQ-M5 now treats Murray as the likely original surname; the next task is identifying Ann's father and direct record trail | Lewis County Murray deeds; Kinawley/Clogher registers; PRONI; passenger lists |
