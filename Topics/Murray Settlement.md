...
1. **Lewis County deed records (Weston Courthouse / FamilySearch)** — Search for Murray surname and variants in deeds 1825–1855. The earliest Murray purchaser in the settlement zone is likely the anchor. Also examine all of Weeden Hoffman's land transactions — if he sold to multiple Irish Catholic families (Copleys, Murrays, Dolans), he may have been the land broker enabling the settlement.
   - **RESEARCH IN PROGRESS:** See [[RQ-M1-LEWIS-COUNTY-DEED-SEARCH|RQ-M1 Deed Search]] for FamilySearch navigation details, [[RQ-M1-JOHN-MURRAY-DEED-FINDINGS|RQ-M1 John Murray Deed Findings]] for the closed direct-deed path, and [[RQ-M1-LEWIS-COUNTY-FAN-SWEEP|RQ-M1 Lewis County FAN Sweep]] for the active Lewis County census workstream. The April-May 2026 Claude for Chrome work produced a negative compiled Grantor Index M-S check, a completed exact-surname Murray grantee-index search with only later 1865-1934 entries on images 553-554, controlled mismatches for physical pages 334 and 404 in Deed Book C-D, a final re-reading of the old "Marwee Sewig" line as **Marwee Sawig**, not Murray, and corrections showing that the supposed **1826 Murray / Fish** and **1833 John Murray** deeds are both actually **1899** oil-and-gas leases. The **1850**, **1860**, and **1870** FAN-sweep passes are now complete, the 1860 / 1870 image-capture pass confirms the Dolan / Murry / Weston and Battelle / Willey clusters, the Murry continuity pass traces Luke to Rhode Island and adult Patrick to Sheridan / Lewis and Sand Fork of Kent, the Murry vital-record and original-image passes verify the main marriage / death evidence and confirm Patrick's parents as Luke and Margaret Murry, and the two older-Luke indexed searches are negative for an independent parent-couple record. Round 2 also found no Luke and no Irish-born Murray / Murry / Murrey in the complete indexed 1850 Lewis County Murray population. The district-geography pass points the cluster toward the Weston / courthouse hinterland, and the Mary Casey plus Byrne / Carey checks add Casey and Byrne as a small Willey Irish presence while correcting the apparent Carey household as likely a Casey continuation. The next phase is a non-indexed county / church records access map and request packet, plus Kinawley-household work, rather than more direct John Murray deed hunting.

2. **US Census 1840, 1850, 1860, 1870** — FAN-club method: extract every Irish-origin surname within the same township as the Copley parcels (Cove Lick/Copley Road area). This will enumerate the full settlement membership. The **1850, 1860, and 1870** passes are complete, with direct image capture now complete for the key 1860 / 1870 cluster pages and Murry continuity now traced after 1860; 1840 remains a harder early-control search, and the current priority is non-indexed Lewis County tax / estate / probate / church access mapping. Capture results first in [[RQ-M1-LEWIS-COUNTY-FAN-SWEEP|RQ-M1 Lewis County FAN Sweep]].
