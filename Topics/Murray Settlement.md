...
1. **Lewis County deed records (Weston Courthouse / FamilySearch)** — Search for Murray surname and variants in deeds 1825–1855. The earliest Murray purchaser in the settlement zone is likely the anchor. Also examine all of Weeden Hoffman's land transactions — if he sold to multiple Irish Catholic families (Copleys, Murrays, Dolans), he may have been the land broker enabling the settlement.
   - **RESEARCH IN PROGRESS:** See [[RQ-M1-LEWIS-COUNTY-DEED-SEARCH|RQ-M1 Deed Search]] for FamilySearch navigation details and [[RQ-M1-JOHN-MURRAY-DEED-FINDINGS|RQ-M1 John Murray Deed Findings]] for the current findings log. Prior index entries are confirmed for 1826 Murray/Fish and 1833 John Murray; deed text is still pending. The April 2026 Claude for Chrome work also found probable "Marwee" / possible Murray entries in Deed Book C-D on pages 334, obscured 3??, and an old 404 target, plus a negative compiled Grantor Index M-S check. A follow-up exact-surname Murray search of the compiled grantee index found only later entries dated 1865-1934 on images 553-554, and a second follow-up confirmed that physical page 404 is a mismatch containing Green/Fleming certificate material rather than a Camden/Murray deed. That is a useful negative result, but it does not resolve the earlier variant/deed-body problem.
...
16. **Transcribe Lewis County John Murray deeds** — The 1826 and 1833 John Murray deed leads, plus the remaining Deed Book C-D "Marwee" / possible Murray targets, may identify the Murray anchor family, witnesses, neighbors, or land near the later Copley settlement. The exact-surname compiled grantee-index search is already complete and negative for pre-1843 entries, and physical page 404 is now a confirmed mismatch, so the next work is page-334, obscured-3??, and index-logic resolution in [[RQ-M1-JOHN-MURRAY-DEED-FINDINGS|RQ-M1 John Murray Deed Findings]].
...
9. ⚠️ [[References/Claude for Chrome Lewis County Deed Research Brief|Claude for Chrome Lewis County Deed Research Brief]], [[References/Claude for Chrome Lewis County Murray Grantee Search|Claude for Chrome Lewis County Murray Grantee Search]], and [[References/Claude for Chrome Lewis County Deed Book C-D Page 404 Check|Claude for Chrome Lewis County Deed Book C-D Page 404 Check]], all April 2026 — FamilySearch deed-index handoffs identifying DGS 8219256 built-in "Marwee" / possible Murray targets, a negative compiled Grantor Index M-S check, a completed exact-surname Murray grantee-index search with only 1865-1934 entries, and a controlled negative result showing that physical page 404 does not match the old Camden/Marwee target. **Promising but still incomplete source path; early deed texts remain untranscribed.**
