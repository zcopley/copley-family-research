...
- A smaller **Willey district** Irish farming cluster around **Thomas Hanahan / Hanrahan** and **Thomas / Bridget Cummings**. A suspected additional Ireland-born household on image 265 was later corrected as the Virginia-born **Jasper Butcher** household.
...
**Interpretation:** The census evidence now supports a broader Irish farming-settlement pattern in Lewis County more strongly than a simple Murray-led model. The next work is a narrow **Mary Casey / Willey** household check and independent image capture for the key 1850-1870 cluster pages. See [[References/Claude for Chrome Lewis County 1870 FAN Sweep]], [[References/Claude for Chrome Lewis County 1870 Image Review]], [[References/Claude for Chrome Lewis County Census District Geography]], and [[RQ-M1-LEWIS-COUNTY-FAN-SWEEP|RQ-M1 Lewis County FAN Sweep]].
