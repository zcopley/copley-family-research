...
**Current execution priority:** For a single browser-based research session such as Claude for Chrome, the highest-value next move is an **older Luke & Margaret Murry identity search**. The original death image confirms Patrick's parents as Luke and Margaret Murry; the next proof step is to determine whether that older couple can be found in Lewis / Gilmer / Harrison records or St. Michael's sacramental records.
...
- Search for the older Luke Murry and Margaret Murry parent couple before any new broad surname sweep.
