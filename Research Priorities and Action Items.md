...
**Current execution priority:** For a single browser-based research session such as Claude for Chrome, the highest-value next move is to **verify the James Murray tax row and recover district / commissioner context if possible**. The May 2026 personal-property-tax handoff found Eliza Jane Murry in 1853 and James Murray plus Patrick Murry in the apparent 1854 sequence; Patrick's row is now image-verified by Claude for Chrome, while James, Eliza Jane, the Loghan rows, 1855 partial coverage, and 1856-1860 remain open.
...
- Verify the James Murray row on `i3811884-00377` and inspect proof page `i3811884-00378` for district, commissioner, and year clues before broadening back out.
- Capture exact original tax-list images and line reads for Eliza Jane, James, and the 1854 Loghan entries before upgrading those tax-list rows to verified.
