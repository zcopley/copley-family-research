...
**Current execution priority:** For a single browser-based research session such as Claude for Chrome, the highest-value next move is a **non-indexed Lewis County records access map and request packet**. The older Luke / Margaret indexed searches are now negative across the obvious online paths, so the next proof step is to identify the specific offline, locked, FamilySearch-center, courthouse, WV State Archives, and diocesan records that should be requested for early Luke / Patrick Murry evidence.
...
- Map non-indexed Lewis County tax, estate, probate, grantor-side land, and Catholic church paths before any new broad surname sweep.
