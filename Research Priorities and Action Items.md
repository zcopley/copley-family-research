...
| Michael Copley Sr. origins | Kilgefin / Fairymount remains the strongest working origin. The 1897 Lewis County death-register row now supports **John Copley** and **Sarah Copley** as recorded parent names, but the same record context incorrectly names **Bridget Copley** as wife / source, gives Lewis County rather than Ireland as birthplace, and gives no Dolan maiden name. Sarah Dolan therefore remains unproven. | Seek corroborating probate, Bible, heirship, church, Irish parish, or estate evidence for John / Sarah and especially Sarah's maiden surname; connect the documented Fairymount Copely family to Michael through parish, civil, or collateral records. |
