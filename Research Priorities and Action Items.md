...
| Murray Settlement | Plausible high-value framework for the Lewis County Irish Catholic cluster; the direct deed path is exhausted; the 1850, 1860, and 1870 FAN sweeps are complete. The 1870 image review shows Battelle image 8 has a denser Irish farming cluster than the surname search revealed, including Fish, likely Foley / Riley, Mulooly, and an unread Ireland-born farmer. | Do line-level review for the unread 1870 Irish households, then map 1850 District 30 / 1860 blank rural pages to later township names. |
...
- Preserve the completed first 1870 image review: Battelle image 8 has four Ireland-born farming heads; image 45 confirms Weston post office for Battelle; image 265 confirms Weston post office for Willey.
- Run line-level follow-up on the unread 1870 Ireland-born households on Battelle image 8 and Willey image 265.
