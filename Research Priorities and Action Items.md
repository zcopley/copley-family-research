...
| Murray Settlement | Plausible high-value framework for the Lewis County Irish Catholic cluster; the direct deed path is exhausted; the 1850, 1860, and 1870 FAN sweeps are complete. The corrected 1870 image review shows Battelle image 8 has a denser Irish farming cluster than the surname search revealed, the district-geography pass points the visible cluster toward the Weston / courthouse hinterland, and the Mary Casey check confirms a Thomas / Mary Casey Irish-born household in Willey. | Check John Byrne and the adjacent Carey household near the Casey page, then independently capture key census images. |
...
**Current execution priority:** For a single browser-based research session such as Claude for Chrome, the highest-value next move is a **John Byrne / Carey household check** around the 1870 Willey Casey page. The Mary Casey check confirmed Thomas and Mary Casey as Ireland-born; John Byrne on image 209 has an Irish surname but unverified birthplace, and the adjacent image 210 has an 8-person Carey household that may extend the Willey Irish cluster.
...
- Run a narrow John Byrne / Carey check before any new broad surname sweep.
