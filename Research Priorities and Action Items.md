...
| Murray Settlement | Plausible high-value framework for the Lewis County Irish Catholic cluster; the direct deed path is exhausted; the 1850, 1860, and 1870 FAN sweeps are complete. The corrected 1870 image review shows Battelle image 8 has a denser Irish farming cluster than the surname search revealed, including Bush, Leely, Mulooly, and McDonald; the supposed extra Willey image 265 Irish household was a false read of the Butcher household. | Map 1850 District 30 / 1860 blank rural pages to later township names, then independently capture key census images. |
...
**Current execution priority:** For a single browser-based research session such as Claude for Chrome, the highest-value next move is **district mapping for the Lewis County census clusters**. The broad 1870 sweep and image-review correction are complete; the remaining question is how 1850 District 30, the 1860 blank rural pages, and the 1870 Battelle / Willey townships relate to Weston, Cove Lick, Camden, Loveberry, and the 1843 Copley parcel.
...
- Map 1850 District 30 and the 1860 blank rural pages to 1870 township geography before drawing stronger location conclusions.
