...
**Current execution priority:** For a single browser-based research session such as Claude for Chrome, the highest-value next move is a **Murry vital-record image and locality check**. The continuity search is complete; the next proof step is to capture the underlying marriage/death records and map Sheridan / Sand Fork of Kent.
...
- Capture the Luke Murray / Anne Loghan marriage, Patrick Murray / Mary Donahoe marriage, and Patrick Murry death images before any new broad surname sweep.
