...
**Current execution priority:** For a single browser-based research session such as Claude for Chrome, the highest-value next move is a **Murry original-image transcription check**. The vital-record index pass is complete; the next proof step is to read the original WV Culture / FamilySearch images and resolve whether Patrick's father really appears as Luke Murry in the death register.
...
- Preserve the completed Murry vital-record index result: Luke / Anne Loghan married 30 December 1854; Patrick / Mary Donahoe married 27 December 1862; Patrick died 22 August 1871 at Sand Fork of Kent; the death index names father Luke and mother Margaret, but the relationship to the 1854 Luke is unresolved.
- Directly transcribe the Luke Murray / Anne Loghan marriage, Patrick Murray / Mary Donahoe marriage, and Patrick Murry death images before any new broad surname sweep.
