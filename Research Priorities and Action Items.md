...
| Murray Settlement | Plausible high-value framework for the Lewis County Irish Catholic cluster; the direct deed path is exhausted; the 1850, 1860, and 1870 FAN sweeps are complete. The corrected 1870 image review shows Battelle image 8 has a denser Irish farming cluster than the surname search revealed, and the district-geography pass points the visible cluster toward the Weston / courthouse hinterland rather than directly to Cove Lick / Camden / Loveberry. | Check the newly surfaced Mary Casey household in Willey, then independently capture key census images. |
...
**Current execution priority:** For a single browser-based research session such as Claude for Chrome, the highest-value next move is a **Mary Casey / Willey household check**. The district-geography pass is complete enough for the current phase and surfaced Mary Casey (b. about 1830, Ireland) in Willey, HH 8, line 39, ARK `MZ4L-G5R`, outside the prior Ireland-born inventory.
...
- Run a narrow Mary Casey / Willey household check before any new broad surname sweep.
