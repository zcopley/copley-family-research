...
**Current execution priority:** For a single browser-based research session such as Claude for Chrome, the highest-value next move is a **non-indexed Lewis County tax / estate path check**. The older Luke / Margaret indexed search was negative, so the next proof step is to identify whether browse-only or locked county records can be checked for early Luke / Patrick Murry evidence.
...
- Preserve the completed older Luke / Margaret indexed search as negative: no independent digitized FamilySearch / WV Culture / Find A Grave record was found for the parent couple.
- Check non-indexed Lewis County tax, estate, probate, and grantor-side land paths before any new broad surname sweep.
