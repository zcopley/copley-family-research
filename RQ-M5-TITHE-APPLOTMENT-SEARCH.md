---
title: RQ-M5 Research — Tithe Applotment Books Search (Kinawley, Fermanagh)
date: 2026-04-25
tags:
  - "#copley-family"
  - "#rq-m5"
...
graph TB
    subgraph VERIFIED["✅ VERIFIED (Primary Source)"]
        V1["Munday surname exists<br/>in Irish Tithe records<br/>11 Ancestry entries<br/>all Ireland"]
    end
    
    subgraph INCONCLUSIVE["⏳ INCONCLUSIVE (Coverage Gap)"]
        I1["Kinawley parish<br/>NOT indexed in NAI<br/>or Ancestry results"]
        I2["Cannot confirm/deny<br/>Munday or Murray<br/>presence in Kinawley"]
    end
    
    subgraph NEXT_TEST["📊 NEXT CRITICAL TESTS"]
        N1["Kinawley Murray<br/>father candidates"]
        N2["Lewis County John Murray<br/>deed transcription"]
        N3["Direct church/passenger<br/>record search"]
    end
    
    V1 -->|Finding| FINDING["FINDING:<br/>Munday is real Irish<br/>surname, not artifact"]
    I1 --> INCONCLUSIVE
    I2 --> INCONCLUSIVE
    
    INCONCLUSIVE -->|Result| VERDICT["VERDICT:<br/>Inconclusive due to<br/>database gap"]
    FINDING --> VERDICT
