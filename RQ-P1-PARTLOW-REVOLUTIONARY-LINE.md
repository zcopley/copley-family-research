...
| Best immediate proof target | Send the verified IRAD-EIU / Clark County request for **Probate Journal vol. CC p. 166** and any surviving **estate packet / estate papers box 46**. The online guardian-book path through Book B is now checked negative through about Feb. 1871. |
...
flowchart TD
    ...
    A --> B --> C --> D --> E --> F --> G --> I --> H
    F -. "current priority" .-> P["Best next targets:<br/>Probate Journal vol. CC p. 166;<br/>estate packet box 46;<br/>Mary Halleck / Isaac corroboration"]
...
1. Send the verified request package to IRAD-EIU first: `archives@eiu.edu`, phone `217-581-6093`, asking for Probate Journal / Probate Order Book volume **CC**, page **166**, and any surviving Jacob Partlow estate packet / estate papers indexed as **box 46**.
...
6. Use Rappahannock / Culpeper / Spotsylvania records for Benjamin-family collateral context, not as proof of Jacob as Benjamin's heir unless a new direct record appears.
