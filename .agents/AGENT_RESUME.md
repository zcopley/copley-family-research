...
- Integrated Zach's June 2026 DGS `7655347` / `7655349` companion-reel follow-up:
  ...
  - changed the remaining web-only Partlow probate task to continuing Guardian Record Book B from image `007655349_00408` forward through about 1871, while treating `PARTLOW John M. - 1/28` as unresolved but bounded unless a new candidate series or higher-resolution reread appears.
...
- Jacob Partlow's Clark County will-book entry and probate-index entry are now both found. Do not reassign the original-will, probate-index image search, `CC 166` as an online target, 1868-1872 searchable Marshall newspaper searches, DGS `7655347` P-section / page-28 checks, or Guardian Record Book B pages 1-41. The offline targets are Probate Journal / Probate Order Book vol. CC p. 166 and estate packet box 46. The next web-only Partlow probate task is explicit: continue Ancestry collection 9048 / FamilySearch DGS `7655349`, Guardian Record Book B, from image `007655349_00408` forward through about 1871 for Partlow / Ritenhouse / Ridenhouse / Rittenhouse / Reddinghause entries, then pursue Mary Halleck / Isaac Partlow / Indiana marriage-register corroboration.
