...
- Partlow next steps:
  ...
  - If the Clerk and Marshall Public Library are negative, ask IRAD whether any post-1899 Clark County marriage volumes or fire-survival / transfer inventories exist, then continue later death, obituary, cemetery, and household records.
