...
Continue the Murray Settlement research, with the highest-priority open question being whether Ann Munday was actually Ann Murray.
...
- Resume with the highest-value evidence search for RQ-M5:
  - Kinawley / Fermanagh Tithe Applotment Books coverage
  - Lewis County census and deed sweep for an independent Munday family
  - Marriage record or church record verification for Michael + Ann
...
- Is "Munday" an independent surname in Ann's origin records, or a transcription of "Murray"?
