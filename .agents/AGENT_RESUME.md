...
- Public web searching did not fully prove Frank Partlow = Nollie Franklin Partlow, but the 14 Jun 1900 *Clark County Herald* notice proves a license was issued under 8 Jun to Frank Partlow, age 25, Moonshine, and Alice Rude, age 19. A later online county-record access-path pass did not find an original or reconstructed record online. The next concrete action is a direct Clark County Clerk / Recorder request plus Marshall Public Library lookup for the original or reconstructed license / return / register entry or local extract, especially `Extract of marriages from Clark County, 1819-1900`, v. 3; if Marshall cannot check it, use FamilySearch Library call no. `977.371 V25c` v. 3 or Film 1036682 / DGS 7955859. Later death, obituary, cemetery, and household records are still needed to tie Frank N / Nollie Franklin to Alice / Mary Alice.
...
- Partlow next steps:
  - Prove Frank Partlow = Nollie Franklin Partlow and Alice Rude = Mary Alice Rude/Partlow by requesting the original or reconstructed Clark County license / return / register entry corresponding to the *Clark County Herald* 8 Jun 1900 license notice from the Clark County Clerk / Recorder, and by asking Marshall Public Library to check `Extract of marriages from Clark County, 1819-1900` and local marriage/license volumes.
  - If Marshall Public Library cannot check the extract, use a FamilySearch Library helper for call no. `977.371 V25c` v. 3 or Film 1036682 / DGS 7955859. If the Clerk, Marshall Public Library, and FamilySearch Library paths are negative, ask IRAD whether any post-1899 Clark County marriage volumes or fire-survival / transfer inventories exist, then continue later death, obituary, cemetery, and household records.
