...
- Integrated Zach's June 2026 Jacob Partlow offline probate request package:
  - preserved the cleaned package at `static/sources/claude-partlow/jacob-partlow-offline-probate-request-package-claude-output.txt`;
  - preserved the final contact-verification package at `static/sources/claude-partlow/jacob-partlow-probate-contact-verification-final-request-claude-output.txt`;
  - added ready-to-send request text to `References/Jacob Partlow Clark County Probate Will Lead.md` for IRAD-EIU first, then Clark County Courthouse fallback;
  - recorded verified contact path: IRAD-EIU at Booth Library / Eastern Illinois University, phone `217-581-6093`, email `archives@eiu.edu`; Clark County Courthouse fallback with County Clerk / Recorder `217-826-8311` and Circuit Clerk `217-826-2811`;
  - preserved the wording guardrail that `CC 166` is a likely probate journal / court-order entry until the page is seen, and that repositories should search for any surviving estate packet / estate papers rather than assuming packet survival;
  - updated the live Partlow probate action from "offline target" to "offline request package ready."

- Integrated Zach's June 2026 final Guardian Record Book B web-only browse for Jacob Partlow:
  - preserved the raw report at `static/sources/claude-partlow/jacob-partlow-guardian-book-b-final-browse-claude-output.txt`;
  - recorded that DGS `7655349` images `007655349_00408-00479` were browsed sequentially, with image `00480` used as a February 1871 endpoint;
  - recorded the combined negative range as Guardian Record Book B images `00387-00479`, pages 1-185, roughly Oct./Dec. 1865 through Feb. 1871;
  - recorded no Partlow, Ritenhouse, Ridenhouse, Rittenhouse, Reddinghause, Polly / Mary Ridenhouse, or Polly / Mary Ritenhouse entry in any guardian, ward, or deceased-ancestor position;
  - changed the live Jacob probate task to offline Probate Journal vol. CC p. 166 and estate packet box 46; later Guardian Books C-E are optional lower-priority web-only work, not the current proof target.

- Integrated Zach's June 2026 DGS `7655347` / `7655349` companion-reel follow-up:
  - preserved the raw report at `static/sources/claude-partlow/jacob-partlow-dgs7655347-7655349-followup-claude-output.txt`;
  - recorded that DGS `7655347` Administrator-Guardian Index P section image `007655347_00409` and nearby checked sections did **not** contain Partlow;
  - recorded that executor / administrator bond page 28, image `007655347_00650`, is an Emanuel Branner bond, not a Partlow record;
  - recorded the collateral **James Partlow** executor bond at DGS `7655347`, image `007655347_00640`, page 8, likely for an Elizabeth Partlow estate;
  - recorded that DGS `7655349` Guardian Record Book B has no front index and that pages 1-41 / images `007655349_00387-00407` are checked negative for Partlow / Ridenhouse variants;
  - initially changed the remaining web-only Partlow probate task to continuing Guardian Record Book B from image `007655349_00408` forward through about 1871; the later final Book B browse completed that range through image `007655349_00479`, so the live task is now offline CC p. 166 / box 46, while `PARTLOW John M. - 1/28` remains unresolved but bounded unless a new candidate series or higher-resolution reread appears.

- Integrated Zach's June 2026 `CC 166` / newspaper follow-up for Jacob Partlow:
  - preserved the raw report at `static/sources/claude-partlow/jacob-partlow-cc166-newspaper-followup-claude-output.txt`;
  - recorded that the 1938 *Inventory of the County Archives of Illinois, No. 12 - Clark County (Marshall)* identifies the relevant series as Entry 127, Probate Journal / Probate Order Book / Probate Record;
  - recorded that `PARTLOW Jacob - (CC) 166` means **Probate Journal volume CC, page 166**, and that volume CC is not part of the online seven-reel Ancestry / FamilySearch set;
  - recorded that the Index to Estate Papers points **Partlow, Jacob** to **box 46**, also a physical / offline packet target;
  - recorded that searchable Marshall Public Library Digital Archive and Library of Congress newspaper paths found no 1868-1872 Jacob Partlow estate notice;
  - changed the live web Partlow task from `CC 166` / DGS `7655352` / newspapers to the remaining online companion reels; the later DGS `7655347` / `7655349` report bounded that further to continuing Guardian Record Book B after image `007655349_00407`.
...
- Integrated Zach's June 2026 Jacob Partlow probate-index / packet-search report:
  ...
  - initially changed the live Partlow web task to resolving `(CC) 166`, browsing unsearched later sections of Ancestry collection 9048 / DGS `7655352`, and searching 1868-1872 Marshall / Clark County newspapers; the later CC follow-up superseded that with offline CC / box targets and online DGS `7655347` / `7655349` companion tasks.
...
- Integrated Zach's June 2026 original Jacob Partlow will-book report:
  ...
  - initially changed the live Partlow task from finding the original will-book entry to searching any separate probate packet, docket, bond, inventory, sale bill, settlement, and distribution receipts; later reports narrowed that to Probate Journal vol. CC p. 166, estate packet box 46, and online companion reels DGS `7655347` / `7655349`.
...
- Integrated Zach's June 2026 primary-record check for Jacob Newton Partlow as a child / heir of Benjamin Partlow:
  ...
  - preserved the complete images 5-69 follow-up at `static/sources/claude-partlow/rappahannock-partlow-chancery-1842-002-images-5-69-claude-output.txt`;
  - added `References/Rappahannock Partlow Chancery Case 1842-002.md`;
  - recorded LVA Rappahannock County Chancery Case `1842-002`, original case no. `53`, `John Partlow v. Heir(s) of Benjamin Partlow`, with 69 scanned images online;
  - recorded that the complete 69-image file names Benjamin Partlow's eight child / heir lines, distributes the estate in eight shares, and omits Jacob / Jacob Newton / Nute Partlow throughout;
  - changed the Partlow status from "strong derivative support with a primary gap" to "downstream line proved to John H.; proposed Benjamin connection contradicted";
  - changed the live Partlow web task to identifying Jacob Newton Partlow's correct parents and source trail, with Rappahannock deed/order/fiduciary/tax records retained only for Benjamin-family collateral context.
...
- Integrated Zach's June 2026 FamilySearch search report for the Clark County, Illinois Partlow / Rude marriage:
  ...
  - changed the live Partlow task to Clark County Clerk / reconstructed records, targeted newspaper corroboration, and June 1900 census corroboration.
...
- Integrated Zach's June 2026 Clark County Herald marriage-license notice report for Frank Partlow and Alice Rude:
  - preserved the raw report at `static/sources/claude-partlow/partlow-rude-1900-clark-county-herald-marriage-license-claude-output.txt`;
  - added `References/Clark County Herald 1900 Partlow Rude Marriage License Notice.md`;
  - recorded the notice in the 14 Jun 1900 *Clark County Herald*, Marshall, Illinois, page 4, `Marriage Licenses` column;
  - recorded the printed license group under `June 8--`: `Frank Partlow, 25, Moonshine` and `Alice Rude, 19`;
  - interpreted the notice as proof that a Clark County license was issued and strong support for the reported marriage, while preserving that it is not the ceremony return and does not give officiant, witness, parent, or license-number details;
  - retired broad Marshall-newspaper searching for this notice and moved the live Partlow path to the original / reconstructed Clark County license or return plus later death, obituary, cemetery, and household records tying Frank N / Nollie Franklin to Alice / Mary Alice.

- Integrated Zach's June 2026 Partlow / Rude county-record access-path follow-up:
  - preserved the raw report at `static/sources/claude-partlow/partlow-rude-1900-county-record-access-path-claude-output.txt`;
  - added `References/Clark County Illinois Partlow Rude County Record Access Path.md`;
  - recorded that no original, reconstructed, or derivative county record was found online in FamilySearch collection 1803970, the Illinois Statewide Marriage Index, FamilySearch catalog, Ancestry marriage collections, IRAD online pages, Clark County Clerk portal, or Marshall Public Library online resources;
  - recorded the active contacts as Clark County Clerk / Recorder Laura H. Lee, 501 Archer Avenue, 1st Floor, Room 3, Marshall, IL 62441, phone 217-826-8311, and Marshall Public Library, 612 Archer Ave, Marshall, IL 62441, phone 217-826-2535, email `jpoorman@marshallplib.com`;
  - made the undigitized Clark County Genealogical Society `Extract of marriages from Clark County, 1819-1900` a key library lookup target;
  - preserved the survival caveat that the 30 Dec 1902 courthouse fire caused some record loss or damage, but online sources do not establish whether the 1900 marriage register / Vol. I survived.

- Integrated Zach's June 2026 Marshall Public Library / FamilySearch Library extract-lookup report:
  - preserved the raw report at `static/sources/claude-partlow/partlow-rude-1900-marshall-library-extract-lookup-claude-output.txt`;
  - recorded that Marshall Public Library's public ILS does not list `Extract of marriages from Clark County, 1819-1900`, but the genealogy-room collection may still hold it outside the circulating catalog;
  - recorded FamilySearch catalog `koha:279795` for the Clark County Genealogical Society extract, with v. 3 covering 1881-1900 and including an index;
  - recorded FamilySearch Library holdings: 3rd Floor Books call no. `977.371 V25c` v. 3, and microfilm 1036682, Items 6-8 / DGS 7955859, no online camera access;
  - recorded that Internet Archive, HathiTrust, Google Books, WorldCat / Google, Library of Congress, and Marshall Public Library Digital Archive did not provide an online copy or separate Partlow / Rude extract;
  - recorded that Marshall Public Library email requests are accepted, but the lookup email is drafted only and has not been sent from the repo workflow.
...
- Jacob Partlow's Clark County will-book entry and probate-index entry are now both found. Do not reassign the original-will, probate-index image search, `CC 166` as an online target, 1868-1872 searchable Marshall newspaper searches, DGS `7655347` P-section / page-28 checks, or Guardian Record Book B images `00387-00479`. The verified offline request package is ready for Probate Journal / Probate Order Book vol. CC p. 166 and any surviving estate packet / estate papers box 46; use IRAD-EIU first, then Clark County Courthouse fallback. Later Guardian Books C-E are optional lower-priority web work only if the user insists on continuing web-only probate sweeps; the current proof target is repository outreach.
...
- Partlow next steps:
  - Preserve the June 2026 result that Frank Partlow = Nollie Franklin Partlow, Alice Rude = Mary Alice Rude Partlow, and Marion Elizabeth's parentage are now proved for project purposes by web records. Do not repeat generic FamilySearch, generic 1880 / 1900 census, broad Ancestry, broad Marshall-newspaper, or Clerk / Marshall Library lookup tasks as identity work.
  - Preserve the completed 1850 / 1860 Johnson Township census-image pass for John H. Partlow and Marion M. Partlow. Do not repeat generic 1850 / 1860 FamilySearch census work unless verifying the found ARKs.
  - Open/search Thomas E. Partlow's *The Partlow family and connections* through FamilySearch Digital Library or Geneanet for John H., Jacob, Benjamin, and Virginia / Clark County lines.
  - Search official DAR GRS for Benjamin Partlow, then pursue web-accessible Benjamin Partlow pension, probate, land, tax, and Spotsylvania Will Book A p. 975 evidence.
  - Treat the Clark County Clerk / Marshall Public Library / FamilySearch Library extract path as optional ceremony-detail work only.
...
- Can original web-accessible records prove John H. Partlow as the son of Jacob Partlow?
