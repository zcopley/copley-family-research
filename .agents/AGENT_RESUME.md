...
- Integrated Zach's June 2026 Jacob Partlow offline probate request package:
  ...
  - recorded contact path: IRAD-EIU at Booth Library / Eastern Illinois University, phone `217-581-6093`, email `archives@eiu.edu`; Clark County Courthouse fallback with County Clerk / Recorder `217-826-8311` and Circuit Clerk `217-826-2811`;
...
- Jacob Partlow's Clark County will-book entry and probate-index entry are now both found. Do not reassign the original-will, probate-index image search, `CC 166` as an online target, 1868-1872 searchable Marshall newspaper searches, DGS `7655347` P-section / page-28 checks, or Guardian Record Book B images `00387-00479`. The offline request package is ready for Probate Journal / Probate Order Book vol. CC p. 166 and any surviving estate packet / estate papers box 46; use IRAD-EIU first, then Clark County Courthouse fallback. Later Guardian Books C-E are optional lower-priority web work only if the user insists on continuing web-only probate sweeps; the current proof target is repository outreach.
