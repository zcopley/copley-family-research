...
- Public web searching did not fully prove Frank Partlow = Nollie Franklin Partlow, but the 14 Jun 1900 *Clark County Herald* notice proves a license was issued under 8 Jun to Frank Partlow, age 25, Moonshine, and Alice Rude, age 19. The next concrete action is the original or reconstructed Clark County license / return / register entry for that license, plus later death, obituary, cemetery, and household records tying Frank N / Nollie Franklin to Alice / Mary Alice.
...
- Partlow next steps:
  - Prove Frank Partlow = Nollie Franklin Partlow and Alice Rude = Mary Alice Rude/Partlow by requesting the original or reconstructed Clark County license / return / register entry corresponding to the *Clark County Herald* 8 Jun 1900 license notice, then by checking later death, obituary, cemetery, and household records.
