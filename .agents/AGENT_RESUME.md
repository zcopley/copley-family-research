...
- Jacob Partlow's Clark County will-book entry and probate-index entry are now both found. Do not reassign the original-will, probate-index image search, `CC 166` as an online target, 1868-1872 searchable Marshall newspaper searches, DGS `7655347` P-section / page-28 checks, or Guardian Record Book B images `00387-00479`. The offline targets are Probate Journal / Probate Order Book vol. CC p. 166 and estate packet box 46. Later Guardian Books C-E are optional lower-priority web work only if the user insists on continuing web-only probate sweeps; the current proof target is offline.
