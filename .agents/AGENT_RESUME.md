...
- Integrated Zach's June 2026 Claude for Chrome `koha:268417` / Inventory Book 11 access-map report for Michael Copley Sr.:
  ...
  - recorded DGS 7618832 image 4 as the `Inventory Book 11, Lewis County` cover and image 50 as the pp. 58-59 spread, where p. 59 appears to close a Thomas estate matter;
  - changed the immediate online Michael probate task to checking DGS 7618832 images 50-53 for Appraisement Book 11 p. 59, expanding nearby only if needed;
...
- The highest-value Michael Copley Sr. parentage leads are now: Inventory Book 11 / Appraisement Book 11, Film 825091 / DGS 7618832 images 50-53; courthouse / archive access to Order Book 1-A p. 45; `P 4/155`; Settlement Book 34 p. 176; estate settlement / appraisement / inventory records after the located will; corroboration of the death-register John / Sarah parent names through Lewis County heirship / chancery / oil-title paperwork; any Bible or church evidence naming Sarah's maiden surname; and the ambiguous "Bridget Copley" Bible path, which should be tested through both Reynolds and Gillooly / collateral possibilities. The County Court Order Book v. 6 image 285 / page 496 path is closed as a bounded negative, and FamilySearch `koha:268417` is checked negative for bound probate / fiduciary volumes. Use `References/Michael Copley Sr Parentage Evidence Audit and Request Packet.md` as the control sheet before assigning or integrating more Michael parentage work.
