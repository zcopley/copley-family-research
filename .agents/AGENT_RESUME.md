...
- Integrated Zach's June 2026 primary-record check for Jacob Newton Partlow as a child / heir of Benjamin Partlow:
  ...
  - recorded that images 1-4 include the bill of complaint naming Benjamin Partlow's children / heirs and omitting Jacob / Jacob Newton / Nute Partlow;
  - changed the Partlow status from "strong derivative support with a primary gap" to "downstream line proved to John H.; proposed Benjamin connection disputed / seriously weakened";
  - changed the live Partlow web task to reading Rappahannock chancery images 5-69, checking Rappahannock Will Book A p. 223, Culpeper Deed Book FF pp. 394-395 / nearby Partlow deeds, and searching for Jacob Newton Partlow's correct parents or an explanation for his omission.
...
- The critical Partlow proof work is now John H. -> Jacob and Jacob's correct parentage. A later Rappahannock chancery case names Benjamin Partlow's children / heirs and omits Jacob / Jacob Newton / Nute, so the proposed Jacob -> Benjamin link is disputed rather than merely unproved. The Clark County marriage return is optional ceremony-detail work, not the identity-control target.
...
- Public web searching initially surfaced only derivative/collateral support for Jacob Partlow = son of Benjamin Partlow. The later LVA Rappahannock chancery pass is now controlling: it omits Jacob from Benjamin's heir class. Prioritize remaining images 5-69 of case 1842-002, Rappahannock Will/Fiduciary Book A p. 223, Culpeper Deed Book FF pp. 394-395, and records identifying Jacob's correct parents.
