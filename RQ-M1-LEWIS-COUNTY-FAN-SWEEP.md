...
**Current status:** The bounded Claude for Chrome FAN-sweep passes for **1850**, **1860**, and **1870** are now complete, and the key 1860 / 1870 cluster pages now have a direct image-capture pass, a Murry continuity pass, and a first vital-record verification pass. The 1850 pass found the **Micheal / Patrick Coopley** household in **District 30**, but no broader Irish surname cluster. The 1860 image capture confirms a dense Ireland-born cluster centered on **Dolan / Murry / Tierney** rural farming households, plus a separate **Weston** boarding-house / labor cluster around **Loftus / Barret / Mc Mahan** and other Ireland-born workers. The Murry continuity search shows **Luke Murry** moved from Lewis County to Providence, Rhode Island between late 1866 and March 1867, while the separate adult **Patrick Murry** stayed in Lewis County, appeared in Sheridan / Lewis in 1870, and died at Sand Fork of Kent in 1871. The vital-record pass verifies the Luke Murray / Anne Loghan marriage index, the Patrick Murray / Mary Donahoe marriage index, and the Patrick Murry death index; it also warns that the death index names Patrick's father as **Luke Murry**, creating an unresolved age / two-Luke problem rather than proving that the 1854 Luke and Patrick were brothers. The 1870 image work confirms rural Irish farming clusters in **Battelle** and **Willey**, with **Battelle image 8** now the strongest propertied cluster: **Bush / Leely / Mulooly / McDonald**. The district-geography pass still points the 1850-1870 rural cluster evidence toward the **Weston / courthouse hinterland** rather than directly toward Cove Lick / Camden / Loveberry. The next bounded Murray-specific work is original-image transcription for the WV Culture / FamilySearch vital records, especially Patrick's 1871 death-register parent columns.
