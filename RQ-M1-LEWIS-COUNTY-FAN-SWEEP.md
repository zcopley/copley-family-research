...
**Current status:** The bounded Claude for Chrome FAN-sweep passes for **1850**, **1860**, and **1870** are now complete, and the key 1860 / 1870 cluster pages now have a direct image-capture pass, a Murry continuity pass, a vital-record verification pass, an original-image transcription pass, and two older-Luke / Margaret indexed-search passes. The 1850 pass found the **Micheal / Patrick Coopley** household in **District 30**, but no broader Irish surname cluster. The 1860 image capture confirms a dense Ireland-born cluster centered on **Dolan / Murry / Tierney** rural farming households, plus a separate **Weston** boarding-house / labor cluster around **Loftus / Barret / Mc Mahan** and other Ireland-born workers. The Murry continuity search shows **Luke Murry** moved from Lewis County to Providence, Rhode Island between late 1866 and March 1867, while the separate adult **Patrick Murry** stayed in Lewis County, appeared in Sheridan / Lewis in 1870, and died at Sand Fork of Kent in 1871. The original death-register image confirms Patrick's parents as **Luke & Margaret Murry**, but the older-Luke / Margaret searches found no independent record for that parent couple in FamilySearch, WV Culture, Find A Grave, accessible digitized census / vital collections, indexed Virginia tax collections, indexed West Virginia probate, or the indexed 1850 Lewis County census. The Round 2 search found 36 Murray / Murry / Murrey people in indexed 1850 Lewis County, all Virginia-born, with no Luke and no Irish-born Murray. The 1870 image work confirms rural Irish farming clusters in **Battelle** and **Willey**, with **Battelle image 8** now the strongest propertied cluster: **Bush / Leely / Mulooly / McDonald**. The district-geography pass still points the 1850-1870 rural cluster evidence toward the **Weston / courthouse hinterland** rather than directly toward Cove Lick / Camden / Loveberry. The next bounded Murray-specific work is no longer another indexed search; it is a request-ready access map for non-indexed county, archive, and church records.
